        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className='shad-dialog'>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select users who can view or edit the document
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <Button type='submit' className='gradient-blue flex h-full gap-1 px-5' onClick={shareDocumentHandler} disabled={loading} >
                        {loading ? 'sending...' : 'invite'}
                    </Button>
                </div>
                <div className='my-2 space-y-2'>
                    <ul className='flex flex-col'>
                        {collaborators.map((colllaborator) => (
                            <Collaborator key={colllaborator.id} roomId={roomId} creatorId={creatorId} collaborator={colllaborator} email={email} user={colllaborator}/>
                        ))}
                    </ul>
                </div>
            </DialogContent>
